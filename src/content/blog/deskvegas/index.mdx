---
title: 'DeskVegas 개발 일지: 4일간 만든 멀티플레이 보드게임'
description: '4일 개발 타임라인과 Mirror 네트워크 이슈 해결 기록'
date: 2025-06-23
tags: ['Unity', 'C#', 'Mirror', 'Steamworks']
image: 'assets/deskVegas.webp'
authors: ['hy']
---
...
> ![MainMenuUI](assets/mainMenuUI.webp)
