...
::::::::caution[매 프레임마다 GetComponent 호출]
...
::::::::tip[Awake에서 한 번만 GetComponent 호출하여 캐싱]
...
::::::::note[브릿지 건너는 비용이 비싼 이유]

:::::::note[Managed/Native 경계 넘기 (Interop Call)]
...
:::::::note[GC(Garbage Collector) 관련 작업]
...
```
::::::::
::::::::tip[Animator.StringToHash로 해시 캐싱]
...
::::::::caution[기본 Struct 사용 (리플렉션 발생)]
```csharp title="DictionaryKeyExample1.cs"
...
::::::::tip[IEquatable 구현 (최적화)]
```csharp title="DictionaryKeyExample2.cs"
...
::::::::note[구조체 배열도 완벽하지 않다 (AoS vs SoA)]
